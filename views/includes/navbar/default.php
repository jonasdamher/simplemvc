...
<section class="navbar-content">
	<ul class="navbar-menu m-0">
		<li class="m-0">
			<button type="button" id="btn-search" class="btn btn-square" title="Search" data-toggle="close"><i class="fas fa-search fa-lg"></i></button>
			<input type="search" id="search" class="input d-none" placeholder="Search..." />
			<button type="button" id="btn-quit-search" class="btn btn-square d-none" title="Search quit"><i class="fas fa-times fa-lg"></i></button>
		</li>
	</ul>
</section>